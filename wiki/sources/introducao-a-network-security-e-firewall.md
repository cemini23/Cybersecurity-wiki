---
title: "Introdução a Network Security e Firewall"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1cKOFgjcASjMi90m8BY3xcUzWxN-D-DYd` ([open in Drive](https://drive.google.com/file/d/1cKOFgjcASjMi90m8BY3xcUzWxN-D-DYd/view))
