...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1w-qNDwAG2tjROl9dNWi3VV9SQgZwNWJS` ([open in Drive](https://drive.google.com/file/d/1w-qNDwAG2tjROl9dNWi3VV9SQgZwNWJS/view))
