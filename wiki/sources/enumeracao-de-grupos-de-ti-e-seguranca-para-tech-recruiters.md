---
title: "Enumeração de Grupos de TI e Segurança para Tech Recruiters"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1TEGByOyBsFRVwJqRrLLkU1tFAvtWj5e5` ([open in Drive](https://drive.google.com/file/d/1TEGByOyBsFRVwJqRrLLkU1tFAvtWj5e5/view))
