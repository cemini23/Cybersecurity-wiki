---
title: "Zero Trust Testing Checklist"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1iKn8MsiDNSX_Y7-ezhwHeWbeVpj5MYAI` ([open in Drive](https://drive.google.com/file/d/1iKn8MsiDNSX_Y7-ezhwHeWbeVpj5MYAI/view))
