---
title: "Adversary Simulation with Caldera and Mitre"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `13thswq-O1CXKpXUg_VGBA27-i0aEKndG` ([open in Drive](https://drive.google.com/file/d/13thswq-O1CXKpXUg_VGBA27-i0aEKndG/view))
