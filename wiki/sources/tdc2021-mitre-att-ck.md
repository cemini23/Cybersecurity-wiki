...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1PnygZflHvcC-V_wO4kuiJEE-GGQqNyAF` ([open in Drive](https://drive.google.com/file/d/1PnygZflHvcC-V_wO4kuiJEE-GGQqNyAF/view))
