---
title: "Python Libs for Security PT.1"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1wrt_Y-h8I2S6GtTkfJceBikCGRxBwRpi` ([open in Drive](https://drive.google.com/file/d/1wrt_Y-h8I2S6GtTkfJceBikCGRxBwRpi/view))
