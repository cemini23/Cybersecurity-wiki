...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `14ZZwbdRjDR3RgZO7h2L1FZbMetlGcpCM` ([open in Drive](https://drive.google.com/file/d/14ZZwbdRjDR3RgZO7h2L1FZbMetlGcpCM/view))
