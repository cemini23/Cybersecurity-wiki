---
title: "Maltego Introduction - Creating a simple local Transform EN"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1rrHTmhe2_qWD4FS592Q_DU-l24EjSYBI` ([open in Drive](https://drive.google.com/file/d/1rrHTmhe2_qWD4FS592Q_DU-l24EjSYBI/view))
