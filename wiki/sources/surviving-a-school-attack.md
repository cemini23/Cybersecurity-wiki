---
title: "Surviving a School Attack"
type: source
...
- **Location:** Google Drive — `ebooks Joas` folder, file ID `1OsKOexispVm5so-_Vawf-GQvinKbYuuP` ([open in Drive](https://drive.google.com/file/d/1OsKOexispVm5so-_Vawf-GQvinKbYuuP/view))
