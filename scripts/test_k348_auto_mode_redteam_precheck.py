...
PY = [sys.executable, str(ROOT / "scripts/k348_auto_mode_redteam_precheck.py")]
KEYS = (
    "written_scope", "monitor_named", "multi_context_axis",
    "no_wiki_payloads", "external_enforcement",
)
...
if __name__ == "__main__":
    ...
    test_json_ok()
    test_json_fail()
    print("OK test_k348_auto_mode_redteam_precheck")
