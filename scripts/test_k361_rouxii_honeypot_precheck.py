...
PY = [sys.executable, str(ROOT / "scripts/k361_rouxii_honeypot_precheck.py")]
KEYS = (
    "written_scope", "deception_aware_baseline", "verification_mode",
    "scope_targets", "no_wiki_payloads",
)
...
if __name__ == "__main__":
    test_selftest()
    test_json_ok()
    print("OK test_k361_rouxii_honeypot_precheck")
