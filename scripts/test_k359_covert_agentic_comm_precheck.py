...
PY = [sys.executable, str(ROOT / "scripts/k359_covert_agentic_comm_precheck.py")]
KEYS = (
    "written_scope", "benign_output_predicate", "black_box_receiver",
    "visible_exits", "no_wiki_payloads",
)
...
if __name__ == "__main__":
    test_selftest()
    test_json_ok()
    print("OK test_k359_covert_agentic_comm_precheck")
