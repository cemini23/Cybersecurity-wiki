...
PY = [sys.executable, str(ROOT / "scripts/k365_ble_reid_lab_precheck.py")]
KEYS = (
    "written_scope", "owned_devices", "pairing_vs_link",
    "service_auth", "no_wiki_payloads",
)
...
if __name__ == "__main__":
    test_selftest()
    test_json_ok()
    print("OK test_k365_ble_reid_lab_precheck")
