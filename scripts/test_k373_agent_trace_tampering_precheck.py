...
PY = [sys.executable, str(ROOT / "scripts/k373_agent_trace_tampering_precheck.py")]
KEYS = (
    "written_scope", "oob_logging", "harness_named",
    "integrity_checks", "faithful_asr", "no_wiki_payloads",
)
...
if __name__ == "__main__":
    test_selftest()
    test_json_ok()
    print("OK test_k373_agent_trace_tampering_precheck")
